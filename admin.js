  ...
  `<div class="settingsHub">
    ...
    <details class="panel simpleAdminDetails settingsGroup announcementAdmin">
      <summary>Duyuru Panosu <small>Siteye girince çıkan bilgilendirme</small></summary><div class="simpleDetailsBody settingsBody">
        ...
        <div class="field announcementFontScaleField">
          <label><b>Duyuru yazı boyutu</b></label>
          <div class=rangeLabels><span>Küçük</span><output id=announcementFontScaleOutput>%${Number(settings.siteAnnouncement?.fontScale||100)}</output><span>Büyük</span></div>
          <input class="formControl announcementFontScaleRange" data-preview-target=".siteAnnouncement" type=range min="80" max="130" step="1" value="${Number(settings.siteAnnouncement?.fontScale||100)}" oninput="settings.siteAnnouncement.fontScale=Number(this.value);document.getElementById('announcementFontScaleOutput').textContent='%'+this.value;changed(this.dataset.previewTarget)">
          <div class=help>Başlık, açıklama ve üst küçük yazıyı birlikte orantılı büyütüp küçültür; canlı önizlemede anında görünür.</div>
        </div>
